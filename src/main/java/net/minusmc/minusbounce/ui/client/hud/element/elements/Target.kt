...
class Target : Element() {
    ...
    val radiusCheck = BoolValue("Radius", false)
    val radiusValue = FloatValue("Radius-Strength", 0.0f, 0.0f, 10.0f) {radiusCheck.get()}
    override fun drawElement(): Border? {
        target ?: return null
        val playerInfo = mc.netHandler.getPlayerInfo(target!!.uniqueID) ?: return null
        val healthString = String.format("%.1f - " + mc.thePlayer.health.toInt(), target!!.health)
