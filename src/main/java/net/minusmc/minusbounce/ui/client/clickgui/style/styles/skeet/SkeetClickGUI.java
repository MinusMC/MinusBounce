...
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.Component;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.TabComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.GroupBoxComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.ScrollListComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.checkbox.CheckBoxTextComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.comboBox.ComboBoxTextComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.integerC.SliderIntTextComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.key.KeyBindComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.slider.SliderTextComponent;
...
public final class SkeetClickGUI extends AbstractGuiScreen {
    ...
    public SkeetClickGUI() {
        this.rootComponent = new Component(null, 0.0f, 0.0f, 406f, 350.0f) {
            ...
            public void drawComponent(LockedResolution lockedResolution, int mouseX, int mouseY) {
                ...
                RenderUtils.INSTANCE.drawRect(borderX, borderY, borderX + width, borderY + height, SkeetClickGUI.getColor(0x10110E));
                RenderUtils.INSTANCE.drawRect(borderX + 0.5f, borderY + 0.5f, borderX + width - 0.5f, borderY + height - 0.5f, SkeetClickGUI.getColor(0x373A3A));
                RenderUtils.INSTANCE.drawRect(borderX + 1.0f, borderY + 1.0f, borderX + width - 1.0f, borderY + height - 1.0f, SkeetClickGUI.getColor(0x232323));
                RenderUtils.INSTANCE.drawRect(borderX + 3.0f, borderY + 3.0f, borderX + width - 3.0f, borderY + height - 3.0f, SkeetClickGUI.getColor(0x2F2F2F));
                ...
                RenderUtils.INSTANCE.drawRect(left, top, right, bottom, SkeetClickGUI.getColor(0x151515));
                ...
                if (alpha >= 70.0) {
                    RenderUtils.INSTANCE.drawRect(left, top + 1.5f - 1.0f, right, top + 1.5f - 0.5f, 0x70000000);
                }
        ...
        for(ModuleCategory c : ModuleCategory.values()) {
            TabComponent categoryTab = new TabComponent(this.rootComponent, c.name(), 51.5f, 5.0f, 350f, 341.5f) {
                ...
                public void setupChildren() {
                    List<Module> modulesInCategory = MinusBounce.moduleManager.getModuleOnCategory(c); // bro getModu
                    // cuc ki la met nhe
                    for (Module module : modulesInCategory) {
                        ...
                        for (Value v : Objects.requireNonNull(MinusBounce.moduleManager.getModule(module.getClass())).getValues()) {
        ...
        this.tabSelectorComponent = new Component(this.rootComponent, 3.5f, 5.0f, 48.0f, 341.5f) {
            ...
            public void drawComponent(LockedResolution resolution, int mouseX, int mouseY) {
                ...
                RenderUtils.INSTANCE.drawRect(x, y, x + width, y + this.selectorY, SkeetClickGUI.getColor(789516));
                RenderUtils.INSTANCE.drawRect((x + width - 1.0f), y, (x + width), y + this.selectorY, innerColor);
                RenderUtils.INSTANCE.drawRect((x + width - 0.5f), y, (x + width), y + this.selectorY, outerColor);
                RenderUtils.INSTANCE.drawRect(x, y + this.selectorY - 1.0f, (x + width - 0.5f), y + this.selectorY, innerColor);
                RenderUtils.INSTANCE.drawRect(x, y + this.selectorY - 0.5f, (x + width), y + this.selectorY, outerColor);
                RenderUtils.INSTANCE.drawRect(x, y + this.selectorY + TAB_SELECTOR_HEIGHT, (x + width), (y + height), SkeetClickGUI.getColor(789516));
                RenderUtils.INSTANCE.drawRect((x + width - 1.0f), y + this.selectorY + TAB_SELECTOR_HEIGHT, (x + width), (y + height), innerColor);
                RenderUtils.INSTANCE.drawRect((x + width - 0.5f), y + this.selectorY + TAB_SELECTOR_HEIGHT, (x + width), (y + height), outerColor);
                RenderUtils.INSTANCE.drawRect(x, y + this.selectorY + TAB_SELECTOR_HEIGHT, (x + width - 0.5f), y + this.selectorY + TAB_SELECTOR_HEIGHT + 1.0f, innerColor);
                RenderUtils.INSTANCE.drawRect(x, y + this.selectorY + TAB_SELECTOR_HEIGHT, (x + width), y + this.selectorY + TAB_SELECTOR_HEIGHT + 0.5f, outerColor);
    ...
    public static double getAlpha() {
        return alpha;
    } //nay gio t đung gi dau

    public static int getColor() {
        final ClickGUI clickGuiModule = MinusBounce.moduleManager.getModule(ClickGUI.class);
        return clickGuiModule.getAccentColor().getRGB();
    }
    ...
    public void drawScr(int mouseX, int mouseY, float partialTicks) {
        ...
        final ClickGUI clickGuiModule = MinusBounce.moduleManager.getModule(ClickGUI.class);
        Fonts.fontSFUI35.drawString("A", xx - 1, yy, clickGuiModule.getAccentColor().getRGB()); // dung chua
        GlStateManager.translate(0, 0, -5f);
    } // push de mat me cai nut build luon r
    // deo theo doi dc j luon
