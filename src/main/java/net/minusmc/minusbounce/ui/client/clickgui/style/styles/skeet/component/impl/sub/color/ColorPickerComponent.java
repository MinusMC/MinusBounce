package net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.color;

import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.LockedResolution;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.MathUtils;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.RenderUtil;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.SkeetClickGUI;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.ButtonComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.Component;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.ExpandableComponent;
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.PredicateComponent;
...
public abstract class ColorPickerComponent extends ButtonComponent implements PredicateComponent, ExpandableComponent {
    ...
    private static void drawCheckeredBackground(float x, float y, float x2, float y2) {
        RenderUtils.INSTANCE.drawRect(x, y, x2, y2, SkeetClickGUI.getColor(16777215));
        for(boolean offset = false; y < y2; ++y) {
            for(float x1 = x + (float)((offset = !offset) ? 1 : 0); x1 < x2; x1 += 2.0F) {
                if (x1 <= x2 - 1.0F) {
                    RenderUtils.INSTANCE.drawRect(x1, y, x1 + 1.0F, y + 1.0F, SkeetClickGUI.getColor(8421504));
                }
            }
        }
    } // wtf m skid cai nay a clickgui sieu cap ngu lon vai
    // m lay tu dau lq+ r
    ...
    public void drawComponent(LockedResolution resolution, int mouseX, int mouseY) {
        ...
        RenderUtils.INSTANCE.drawRect(x2 - 0.5f, y2 - 0.5f, (x2 + width) + 0.5f, (y2 + height) + 0.5f, black);
        ...
        if (this.isExpanded()) {
            ...
            RenderUtils.INSTANCE.drawRect(expandedX, expandedY, expandedX + expandedWidth, expandedY + expandedHeight, black);
            RenderUtils.INSTANCE.drawRect(expandedX + 0.5f, expandedY + 0.5f, (expandedX + expandedWidth) - 0.5f, (expandedY + expandedHeight) - 0.5f, SkeetClickGUI.getColor(0x39393B));
            RenderUtils.INSTANCE.drawRect(expandedX + 1.0f, expandedY + 1.0f, expandedX + expandedWidth - 1.0f, expandedY + expandedHeight - 1.0f, SkeetClickGUI.getColor(0x232323));
            ...
            RenderUtils.INSTANCE.drawRect(colorPickerLeft - 0.5f, colorPickerTop - 0.5f, colorPickerRight + 0.5f, colorPickerBottom + 0.5f, SkeetClickGUI.getColor(0));
            ...
            RenderUtils.INSTANCE.drawRect(hueSliderRight - 0.5f, alphaSliderBottom - 0.5f, hueSliderRight, hueSelectorY + 0.5f, black);
            RenderUtils.INSTANCE.drawRect(hueSliderYDif, alphaSliderBottom - 0.5f, hueSliderYDif + 0.5f, hueSelectorY + 0.5f, black);
            RenderUtils.INSTANCE.drawRect(hueSliderRight, alphaSliderBottom - 0.5f, hueSliderYDif, alphaSliderBottom, black);
            RenderUtils.INSTANCE.drawRect(hueSliderRight, hueSelectorY, hueSliderYDif, hueSelectorY + 0.5f, black);
            RenderUtils.INSTANCE.drawRect(hueSliderRight, alphaSliderBottom, hueSliderYDif, hueSelectorY, selectorWhiteOverlayColor);
            ...
            RenderUtils.INSTANCE.drawRect(hueSliderLeft - 0.5f, colorPickerTop - 0.5f, hueSliderRight + 0.5f, colorPickerBottom + 0.5f, black);
            ...
            RenderUtils.INSTANCE.drawRect(hueSliderLeft - 0.5f, hsTop - 0.5f, hueSliderLeft, asRight + 0.5f, black);
            RenderUtils.INSTANCE.drawRect(hueSliderRight, hsTop - 0.5f, hueSliderRight + 0.5f, asRight + 0.5f, black);
            RenderUtils.INSTANCE.drawRect(hueSliderLeft, hsTop - 0.5f, hueSliderRight, hsTop, black);
            RenderUtils.INSTANCE.drawRect(hueSliderLeft, asRight, hueSliderRight, asRight + 0.5f, black);
            RenderUtils.INSTANCE.drawRect(hueSliderLeft, hsTop, hueSliderRight, asRight, selectorWhiteOverlayColor);
            ...
            RenderUtils.INSTANCE.drawRect(colorPickerLeft - 0.5f, alphaSliderTop - 0.5f, colorPickerRight + 0.5f, alphaSliderBottom + 0.5f, black);
            ...
            RenderUtils.INSTANCE.drawRect(asLeft - 0.5f, alphaSliderTop, asRight + 0.5f, alphaSliderBottom, black);
            RenderUtils.INSTANCE.drawRect(asLeft, alphaSliderTop, asRight, alphaSliderBottom, selectorWhiteOverlayColor);
            GL11.glTranslated(0.0, 0.0, -3.0);
        }
    }
