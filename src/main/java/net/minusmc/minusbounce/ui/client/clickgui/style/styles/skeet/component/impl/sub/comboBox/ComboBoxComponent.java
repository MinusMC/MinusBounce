package net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.component.impl.sub.comboBox;
...
import net.minusmc.minusbounce.ui.client.clickgui.style.styles.skeet.SkeetUtils;
...
public abstract class ComboBoxComponent extends ButtonComponent implements PredicateComponent, ExpandableComponent {
    ...
    public void drawComponent(LockedResolution lockedResolution, int mouseX, int mouseY) {
        ...
        RenderUtils.INSTANCE.drawRect(x, y, x + width, y + height, SkeetClickGUI.getColor(855309));
        ...
        if (this.expanded) {
            ...
            RenderUtils.INSTANCE.drawRect(x, y + height, x + width, y + height + dropDownHeight + 0.5f, SkeetClickGUI.getColor(855309));
